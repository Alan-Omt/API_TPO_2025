...
function ListaCatalogo() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch productos
        const productsResponse = await fetch(`${import.meta.env.VITE_REACT_APP_API_URL}/productos`);
        ...
        const categoriasResponse = await fetch(`${import.meta.env.VITE_REACT_APP_API_URL}/categorias`);
            ...
            <div key={product.id} onClick={() => handleProductClick(product.id)}>
              <div className={styles.tarjetaProducto}>
                ...
                <div className={styles.comfirmar}>
                  <button className={styles.botonVer} onClick={() => handleProductClick(product.id)}>
                    Ver
                  </button>
                </div>
              </div>
